...
namespace BoatRent.Core.Tests
{
    ...
    public class RentServiceTests
    {
        ...
        public void RentNotAvailableBoat()
        {
            ...
            //Act
            var result1 = service.RentBoat("12322", Domain.Boat.BoatType.DinghyBoat, "0000", "198809212222", DateTime.Now);
            var result2 = service.RentBoat("12322", Domain.Boat.BoatType.DinghyBoat, "0000", "198809212222", DateTime.Now);
        ...
        public void CalculatePrice()
        {
            ...
            //Act
            var result = service.RentBoat(boatNumber, Domain.Boat.BoatType.DinghyBoat, "0000", "198809212222", new DateTime(2021, 1, 1, 10, 0, 0));
            var receipt = service.ReturnBoat(boatNumber, new DateTime(2021, 1, 1, 14, 20, 0));
